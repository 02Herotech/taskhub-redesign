...
const AddTaskForm: React.FC = () => {
    ...
    const handleTickChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        setIsSelectedTime(event.target.value);
    };
                ...
                return (
                    <div className="mb-10 grid items-center justify-center space-y-10">
                        <form className="space-y-10" onSubmit={nextPage}>
                                ...
                                <div className="flex space-x-3">
                                    <div className="relative">
                                        <DatePicker
                                            ...
                                            id="workDaysTime"
                                            name="workDaysTime"
                                            className="cursor-pointer rounded-2xl border border-grey1 bg-[#EBE9F4] px-2 py-1 outline-none placeholder:text-[14px] hover:bg-purpleBase hover:placeholder:text-white"
                                        />
                                        <IoMdArrowDropdown className="absolute right-5 top-2 cursor-pointer text-purpleBase" />
                                    </div>
                                    <div className="relative">
                                        <DatePicker
                                            ...
                                            id="workDaysDate"
                                            name="workDaysDate"
                                            className="cursor-pointer rounded-2xl border border-grey2 bg-[#EBE9F4] px-2 py-1 outline-none placeholder:text-[14px] hover:bg-purpleBase hover:placeholder:text-white"
                                        />
                                        <IoMdArrowDropdown className="absolute right-5 top-2 text-purpleBase" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                {termsAccepted && (
                                    <div className="mt-2">
                                        <select
                                            ...
                                            name="terms"
                                            className="w-full rounded-2xl border border-grey2 bg-[#EBE9F4] px-3 py-1 text-[14px] text-purpleBase outline-none"
                                        >
                            ...
                            <Button
                                type="submit"
                                className="w-24 rounded-2xl p-3 text-white"
                            >
                                Next
                            </Button>
                        </form>
                            ...
                            <div className="flex space-x-4 text-[13px] text-[#221354]">
                                <button
                                    className={`rounded-2xl p-2 ${activeButtonIndex === 0
                                            ? "bg-purpleBase text-white"
                                            : "bg-[#EBE9F4] hover:bg-purpleBase hover:text-white"
                                        } outline-none`}
                                    name="physical"
        ...
        <div className="mt-20 flex min-h-screen flex-col items-center justify-center">
            ...
            <div className="w-full space-y-3">
                <div className="flex justify-center space-x-5">
                    <div
                        className={`${currentPage === 1 ? "text-purpleBase" : "text-purpleBase"}`}
                    >
                    ...
                    <div
                        className={`${currentPage === 3 ? "text-purpleBase" : " text-[#716F78]"
                            }`}
                    >
                        <p className="flex items-center gap-3">
                            <span
                ...
                <div>
                    ...
                    <div className="flex justify-center">
                        <div
                            className="container flex items-center justify-center space-x-5 border-2 border-[#EAE9EB] p-5"
