                ...
                <div className="space-y-10 font-satoshi">
                    ...
                    <div className="flex w-full items-center space-x-8 max-lg:justify-center">
                        <button
                            ...
                            className={`h-[48px] w-[120px] lg:h-[70px] lg:w-[210px] 
  ${userType === "Customer" ? "border border-primary bg-primary text-white" : "border-none bg-status-lightViolet text-primary"} 
  rounded-2xl text-sm font-bold lg:text-2xl`}
                        >
                            Customer
                        </button>
                        <button
                            ...
                            className={`h-[48px] w-[120px] lg:h-[70px] lg:w-[210px] 
  ${userType === "Service Provider" ? "border border-primary bg-primary text-white" : "border-none bg-status-lightViolet text-primary"} 
  rounded-2xl text-sm font-bold lg:text-2xl`}
                        >
                            Service Provider
                        </button>
