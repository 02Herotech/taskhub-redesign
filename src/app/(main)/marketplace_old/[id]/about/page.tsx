...
const Page = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        if (!id) return;
        const { data } = await instance.get(`listing/${id}`);
  ...
  useEffect(() => {
    const fetchProviderListings = async () => {
      try {
        if (!id) return;
        const url = `service_provider/get-profile/${displayData?.serviceProvider?.id}`;
    ...
    <>
      <main className=" relative  pt-16 font-satoshiMedium text-[#221354] ">
          ...
          <article className="space-y-4 lg:col-span-7">
            <div className="container space-y-4 ">
              <div className="space-y-6 py-4">
                ...
                <div className="listings-center flex justify-between">
                  <div className="listings-center flex gap-4">
                    <Image
                      src={
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        <div className="listings-center flex gap-2">
        ...
        <section className="mx-auto w-full space-y-4 p-4  py-8 lg:p-16 ">
          <h1 className="text-center text-3xl font-bold text-violet-darkHover">
            Portfolio
          </h1>
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="px-2">
                    ...
                    <div className="listings-center flex gap-1">
                    ...
                    <div className="listings-center flex justify-between gap-3">
                      <div className="listings-center flex gap-2 py-3">
                        <Image
                          src={
                            displayData?.serviceProvider.user.profileImage ??
                            "/assets/images/serviceProvider/user.jpg"
