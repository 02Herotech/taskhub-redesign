...
const MareketPlace = () => {
  const categories: Categories = {
    category1: {
      name: "Home Services",
      subcategories: ["Landscaper/ground keeper", "Gardeners", "House Keeping"],
    },
    category2: {
      name: "Beauty",
      subcategories: ["Hair vendors", "Beauty products"],
    },
    category3: {
    ...
    category5: {
      name: "Art and craft",
      subcategories: ["Writer", "Painter", "Artist"],
    },
    category6: {
      name: "Petcare",
      subcategories: ["Dog walker"],
    },
    category7: {
      name: "Custodian",
      subcategories: ["Janitor"],
    },
    category8: {
      name: "Grocery",
      subcategories: ["Grocery delivery"],
    },
  };
              ...
              <div>
                <div>
                  <CategoryListing
                    ...
                    setViewMoreListing={setViewMoreListing}
                    viewMoreListing={viewMoreListing}
                  />
