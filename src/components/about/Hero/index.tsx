                ...
                <div className="py-5 md:flex md:justify-evenly gap-10">
                    <div className='flex items-center justify-center lg:w-1/2'>
                        <Image
                            ...
                            height={800}
                            quality={100}
                            className='size-[300px] lg:size-[500px]'
                        />
                    </div>
                    <div className='space-y-5 lg:space-y-8 lg:w-1/2 md:py-14 max-sm:mt-10'>
                        <h3 className='text-tc-orange text-lg lg:text-2xl font-clashBold font-bold'>About Olójà</h3>
                        <h1 className='text-primary font-satoshiBold font-bold text-3xl lg:text-[40px]'>Every Immigrant needs a product, a service and the provider.</h1>
