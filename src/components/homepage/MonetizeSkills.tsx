...
function MonetizeSkills() {
  return (
    <section className="overflow-x-hidden bg-primary py-10">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto flex w-[85%] flex-col gap-10 lg:flex-row">
          <div
          ...
          <div className="text-white">
            <h2 className="mb-5 font-clashSemiBold text-3xl xl:text-4xl">
              Monetize <br /> your{" "}
              <span className="text-[#E58C06]">skills!</span>
            </h2>
            <p className="mb-10 max-w-[540px] font-satoshiMedium text-base sm:text-xl">
            ...
            <ul className="mb-8 max-w-[550px] space-y-3">
              {perks.map((perk) => (
                <li
                ...
                >
                  ...
                  <div>
                    <h4 className="font-satoshiBold text-base font-bold text-[#EBE9F4] sm:text-xl">
                      {perk.title}
                    </h4>
                  </div>
                </li>
