      ...
      <div className="flex items-center w-full justify-between  ">
        <div className="relative">
          ...
          <div className="flex justify-between  w-full absolute inset-0 items-center ">
            <span
              onClick={gotoPrev}
              className="text-[25px] cursor-pointer hover:text-white  hover:bg-[#ffadaf] bg-[#97A3B6] p-3 rounded-[50%] flex justify-center items-center -ml-7"
            >
              <MdKeyboardArrowLeft />
            </span>
            <span
              onClick={gotoNext}
              className="text-[25px] cursor-pointer hover:text-white hover:bg-[#ffadaf] bg-[#97A3B6] p-3 rounded-[50%] flex justify-center items-center -mr-7"
            >
