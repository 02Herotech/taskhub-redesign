...
const YouCan = () => {
  ...
  return (
      ...
      <div className=' mx-auto max-w-7xl'>
        <div className='w-[85%] mx-auto py-10 '>
          ...
          <div className='space-y-5'>
            <h2 className='xl:text-[40px] text-[32px] font-clashSemiBold text-[#2A1769] text-center'>   With Oló<span className='text-tc-orange'>jà</span>, you can:</h2>
            ...
            <div className='flex justify-between  py-5'>
              {
                YouCanData.map((eachData, index) => (
                  <div className={clsx("flex items-center space-x-4 w-1/3",
            ...
            <div className='flex justify-between'>
              ...
              <div className='w-1/3 flex flex-col items-center gap-16'>
                ...
                <div className='h-[350px] w-full  mx-auto bg-[#2A1769] rounded-[30px] flex items-center justify-center '>
    ...
    p-3 text-white hover:bg-[#e79823] w-[250px] xl:w-[190px] lg:w-[175px]"
                  ...
                  <div className='xl:space-y-12 space-y-14 xl:pl-24 pl-14'>
                    <h2 className='xl:text-[28px] text-[24px] font-clashSemiBold text-primary text-left font-[700]'>
    ...
    p-3 text-white hover:bg-[#25135f] w-[130px]"
              ...
              <div className='w-1/3 pt-36'>
                ...
                <div className='h-[420px]  w-[90%] mx-auto bg-tc-orange rounded-[30px] flex items-center justify-center '>
                  <div className='relative h-[380px] w-[85%] mx-auto rounded-[15px] ' >
                    <Image
