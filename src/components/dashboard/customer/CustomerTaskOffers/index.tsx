  ...
  return (
    <div className="mt-14 min-h-96 pr-5">
      <div className="mb-6 flex items-center justify-between uppercase">
        <h2 className="font-satoshiBold text-xl font-bold text-[#E58C06] lg:text-3xl">
          Offers
        </h2>
        ...
        {offers?.map((offer) => (
          ...
          >
            ...
            {openReplyModal[offer.id] && (
              ...
              >
                <div className="w-full max-w-[600px] rounded-t-3xl bg-white px-5 pb-8 pt-2 transition-all duration-300 lg:rounded-2xl">
                  <div
