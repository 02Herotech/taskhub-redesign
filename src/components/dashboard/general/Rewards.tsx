...
const RewardsComponent = () =>{
    ...
    return (
        <>
            ...
            <div className="bg-[#EBE9F4] p-6 rounded-xl flex flex-col md:flex-row items-center justify-between gap-6 w-[95%] mx-auto mt-5">
                {/* Left Side - Tasks */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full md:w-3/5">
                    {[
                    {
                        icon: "/assets/icons/rewards-green.svg",
                        title: "Assigning tasks.",
                        description: "Earn 10 points by Assigning tasks.",
                        bg: "bg-green-200",
                    },
                    {
                    ...
                    {
                        icon: "/assets/icons/rewards-blue.svg",
                        title: "Bookings",
                        description: "Earn 15 points by Booking services.",
                        bg: "bg-indigo-200",
                    },
                    {
                        icon: "/assets/icons/rewards-orange.svg",
                        title: "Reacting",
                        description: "Earn 5 points by reacting on any offers.",
                        bg: "bg-yellow-200",
                    },
                    ].map((item, index) => (
                    // <div key={index} className="flex items-start gap-4 p-4 rounded-lg shadow-sm bg-white">
                    <div key={index} className="flex flex-row items-center gap-2 p-6 w-full md:w-[340px] h-[120px] rounded-lg">
                        <img className={`p-3 rounded-lg`} src={item.icon} />
                        <div className="text-left">
                            <p className="text-[20px] font-bold text-primary">{item.title}</p>
                ...
                <div className="flex flex-col items-center mr-6">
                    ...
                    <button className="mt-4 bg-orange-500 text-white px-6 py-2 rounded-3xl hover:bg-orange-600 transition">
                        Convert/Use points
                    </button>
                </div>
            ...
            <div className="mt-4">
                <p className="text-black font-bold text-[20px] pl-8">Reward Points history</p>
            </div>
            <div className="flex flex-col items-center justify-center bg-[#EBE9F4] mx-auto w-[95%] px-[1rem] mt-2 rounded-xl text-center min-h-[230px]">
            {loading && !refresh ? (
            ...
            // <div>
                // <div className="flex mt-[-7.5rem] bg-[#EBE9F4] justify-start items-start text-white rounded-xl w-full max-w-lg mr-auto">
