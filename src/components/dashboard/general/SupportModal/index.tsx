...
const ContactSupportModal = ({ onClose }: Props) => {
    return (
        <section
          className={`fixed left-0 top-0 z-50 flex h-screen w-screen items-center justify-center bg-black bg-opacity-60 transition-opacity duration-500 pointer-events-auto opacity-100`}
        >
          <div
