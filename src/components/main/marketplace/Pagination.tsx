...
export default function Pagination({
  ...
  return (
    <nav className="my-4 flex items-center justify-center space-x-2">
      ...
      <button
        onClick={handlePrev}
        className="flex h-10 w-10 items-center justify-center rounded-md bg-gray-100 text-indigo-800"
      ...
      <button
        onClick={handleNext}
        className="flex h-10 w-10 items-center justify-center rounded-md bg-indigo-800 text-white"
