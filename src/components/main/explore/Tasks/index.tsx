  ...
  const handleFilter = async () => {
    try {
      ...
      const { category, location, typeOfService, minPrice, maxPrice } =
        filterDataStructure;
      let url = `${process.env.NEXT_PUBLIC_API_URL}/task/filter-tasks/0?`;
      const params = [];
    ...
    <section className="container py-10">
      ...
      <section className="py-10">
        <div className="flex w-full items-center justify-between">
          <form
            className="flex items-center space-x-4 max-lg:my-4 max-lg:w-full max-lg:justify-between max-lg:px-1"
          ...
          >
            ...
            <button
              type="submit"
              className="flex h-[29px] w-[29px] items-center justify-center rounded-lg bg-primary lg:h-[55px] lg:w-[55px] lg:rounded-2xl"
            >
          ...
          <div className="flex flex-wrap gap-4 space-x-2 text-xs lg:space-x-6 ">
            ...
            <div className="relative">
              ...
              >
                ...
                {filterDataStructure.typeOfServiceDisplay === ""
                  ? "Type of service"
                  : truncateText(filterDataStructure.typeOfServiceDisplay, 12)}
                <span>
                  <BsTriangleFill
                    fill="rgb(56 31 140)"
                    className="size-2 rotate-[60deg] text-violet-normal"
